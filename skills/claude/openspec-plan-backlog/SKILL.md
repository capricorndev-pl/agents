...
description: Shape a prioritized backlog of OpenSpec changes from current specs, docs, code, and active work. Use when the agent needs to suggest what proposals should exist next, how to split work into coherent changes, and in what order those changes should be tackled based on dependencies, risk, and delivery value.
license: MIT
